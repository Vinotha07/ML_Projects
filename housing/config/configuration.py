...
class Configuration:
    ...
    def __init__(self, 
        ...
        self.training_pipeine_config=self.get_training_pipeline_config
        self.time_stamp=current_time_stamp

    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            artifact_dir=self.training_pipeine_config.artifact_dir
            ...
            ingested_train_dir=os.path.jon(
                ingested_data_dir,
                data_ingestion_info[DATA_INGESTION_TRAIN_DIR_KEY]
            )

             ingested_test_dir=os.path.jon(
                ingested_data_dir,
